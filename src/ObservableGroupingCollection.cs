...
#region Private members
         ...
         * Thus, for each range operation only the first item is going to be processed, e.g. InsertRange(0, [1]..[3]) is analogous to Insert(0, [1]) from the perspective of the CollectionView.
